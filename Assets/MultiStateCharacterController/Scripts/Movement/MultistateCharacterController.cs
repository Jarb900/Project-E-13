...
using System.Linq;
using MultiStateCharacterController.Scripts.CameraAndInput;
using MultiStateCharacterController.Scripts.RailSystems;
using UnityEngine;
using UnityEngine.Events;

namespace MultiStateCharacterController.Scripts.Movement
{
    public class MultistateCharacterController : MonoBehaviour
    {
        ...
        void MoveTowardsStepTransitionalValue()
        {
            ...
            if (settings.movementStateSettings.movementState == MovementState.onRails && settings.railSystemSettings.railSystem != null)
            {
                ...
                {
                    direction = settings.directionalVectorModifiers.externalTargetValue - settings.directionalVectorModifiers.referencePosition;
                    settings.rigidbodyForceModifiers.playerRigidbody.linearVelocity = direction;
                    return;
                }
        ...
        public void ChangeState(MovementState newState)
        {
            ...
            if (newState == MovementState.jumping)
            {
                ...
                {
                    settings.rigidbodyForceModifiers.playerRigidbody.linearVelocity = new Vector3(0, 0, 0);
                }
                else
                {
                    settings.rigidbodyForceModifiers.playerRigidbody.linearVelocity = new Vector3(settings.rigidbodyForceModifiers.playerRigidbody.linearVelocity.x * settings.jumpingControls.jumpHorizontalForceMultipler, 0, settings.rigidbodyForceModifiers.playerRigidbody.linearVelocity.z * settings.jumpingControls.jumpHorizontalForceMultipler);
                }
            }
            ...
            if (newState == MovementState.ragdoll)
            {
                ...
                {
                    rigidbody.linearVelocity = new Vector3(rigidbody.linearVelocity.x, settings.mSRagdoll.initialRagdollYVelocity, rigidbody.linearVelocity.z);
                }
            }
        ...
        {
            settings.rigidbodyForceModifiers.playerRigidbody.linearDamping = drag;
        ...
        {
            if (settings.directionalVectorModifiers.fallTime == 0) settings.jumpingControls.jumpStartingVelocity = settings.rigidbodyForceModifiers.playerRigidbody.linearVelocity;
        ...
        void CheckForFallProtection()
        {
            ...
            if (settings.rigidbodyForceModifiers.playerRigidbody.linearVelocity.magnitude < 1)
            {
        ...
        public void AttemptFlyFromFall()
        {
            ...
            if (settings.movementStateSettings.movementState == MovementState.falling || settings.movementStateSettings.movementState == MovementState.jumping)
            {
                ...
                //ChangeState(MovementState.flying);
                settings.rigidbodyForceModifiers.playerRigidbody.linearVelocity = Vector3.zero;
